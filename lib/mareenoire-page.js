...
export function getMareeNoirePageData() {
  ...
  return {
    ...
    audio: {
      ...
      mimeType: "audio/mp4",
      durationSeconds: 905.462,
      chapters: [
        { label: "01", title: "Le concept", time: 0 },
        { label: "02", title: "Les personnages", time: 79.81 },
        { label: "03", title: "Les arènes", time: 573.487 },
        { label: "04", title: "Les grandes thématiques", time: 672.54 },
        { label: "05", title: "Le mot de Give Me The Pitch", time: 860.51 },
      ],
    },
    beforeTest: [
