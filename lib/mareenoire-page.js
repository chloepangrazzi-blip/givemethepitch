...
export function getMareeNoirePageData() {
  ...
  return {
    ...
    audio: {
      kicker: "Livre audio",
      title: "Écouter le dossier",
      description:
        "Une lecture audio continue et chapitrée du dossier, pour suivre Marée Noire sans quitter la page.",
      durationLabel: "15 min",
      chapterCountLabel: "5 chapitres",
      note: "Lecture intégrale du dossier, découpée en cinq chapitres pour reprendre facilement la lecture.",
      stickyLabel: "Livre audio · Marée Noire",
      ctaLabel: "Écouter le dossier",
      pauseLabel: "Mettre en pause",
      resumeLabel: "Reprendre l'écoute",
      jumpLabel: "Voir les chapitres",
      compactJumpLabel: "Chapitres",
      src: "/audio/maree-noire-dossier.m4a",
      mimeType: "audio/mp4",
      durationSeconds: 957.877,
      chapters: [
        { label: "01", title: "Le concept", time: 0 },
        { label: "02", title: "Les personnages", time: 88.986 },
        { label: "03", title: "Les arènes", time: 626.748 },
        { label: "04", title: "Les grandes thématiques", time: 725.238 },
        { label: "05", title: "Le mot de Give Me The Pitch", time: 913.248 },
      ],
    },
    beforeTest: [
    ...
    intro: {
      ...
      notes: [
        "Regarder le teaser dans de bonnes conditions.",
        "Lire ou écouter l'ensemble des rubriques avant de répondre.",
        "Lancer le test seulement lorsque la lecture est prête.",
