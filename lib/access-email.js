                  ...
                  <tr>
                    <td bgcolor="#080808" class="dark-bg white-text" style="padding:42px 28px 34px;background:#080808;background-color:#080808;background-image:linear-gradient(#080808,#080808);font-family:Arial,'Helvetica Neue','Segoe UI',sans-serif;color:#ffffff;line-height:1.65;border-radius:18px;">
                      ...
                      <div style="margin:0 0 28px;text-align:center;">
                        <span class="rose-bg dark-text" style="display:inline-block;max-width:100%;padding:12px 18px;border-radius:999px;background:#f5c6d8;background-color:#f5c6d8;background-image:linear-gradient(#f5c6d8,#f5c6d8);color:#080808;font-family:Poppins,Arial,'Helvetica Neue','Segoe UI',sans-serif;font-size:12px;font-weight:300;letter-spacing:0.16em;line-height:1.5;text-transform:uppercase;text-align:center;box-sizing:border-box;">
