...
function buildEmailDocument(content) {
  ...
  <html lang="fr" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="page-bg body" style="margin:0;padding:0;background:#080808;background-color:#080808;background-image:none;">
...
export function buildAccessEmailHtml({ fullName, accessCode, keyaccessUrl }) {
  ...
  return buildEmailDocument(`
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#080808" class="page-bg email-shell" style="margin:0;padding:0;background:#080808;background-color:#080808;background-image:linear-gradient(#080808,#080808);border-collapse:collapse;">
      <tr>
              ...
              <td bgcolor="#c8f5e8" class="mint-bg" style="padding:18px;background:#c8f5e8;background-color:#c8f5e8;background-image:linear-gradient(#c8f5e8,#c8f5e8);border-radius:28px;">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#080808" class="dark-bg" style="width:100%;background:#080808;background-color:#080808;background-image:linear-gradient(#080808,#080808);border:1px solid #c8f5e8;border-radius:18px;border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;">
                  <tr>
                    <td bgcolor="#080808" class="dark-bg white-text" style="padding:42px 28px 34px;background:#080808;background-color:#080808;background-image:linear-gradient(#080808,#080808);font-family:Arial,'Helvetica Neue','Segoe UI',sans-serif;color:#ffffff;line-height:1.65;border-radius:18px;">
                      <p class="white-text" style="margin:0 0 18px;font-size:16px;color:#ffffff;">Bonjour ${safeFirstName},</p>
                      <p class="white-text" style="margin:0 0 18px;font-size:15px;color:#ffffff;line-height:1.5;">Vous faites partie des premi&#232;res personnes inscrites &#224;&nbsp;<span style="display:inline;color:#ffffff !important;-webkit-text-fill-color:#ffffff !important;font-family:Arial,'Helvetica Neue','Segoe UI',sans-serif;font-weight:400;letter-spacing:0;text-transform:uppercase;white-space:nowrap;">GIVE ME THE PITCH.</span><br>Merci de faire partie de ce premier cercle&nbsp;: votre pr&#233;sence ici et votre soutien sont pr&#233;cieux.</p>
                      <p class="white-text" style="margin:0 0 14px;font-size:16px;color:#ffffff;">Vous &#234;tes aujourd&#8217;hui invit&#233;&#183;es &#224; d&#233;couvrir le premier projet original mis en ligne sur la plateforme. Il s&#8217;agit de <span style="display:inline-block;color:#ffffff !important;-webkit-text-fill-color:#ffffff !important;font-family:Arial,'Helvetica Neue','Segoe UI',sans-serif;font-weight:400;letter-spacing:0;text-transform:uppercase;">Mar&#233;e noire</span>, un thriller fantastique dont voici le pitch.</p>
                      <table role="presentation" align="center" cellpadding="0" cellspacing="0" border="0" style="margin:0 auto 18px;border-collapse:separate;">
                        <tr>
                          <td class="pitch-box" style="padding:14px 16px;border:1px solid #c8f5e8;border-radius:18px;background:#080808;background-color:#080808;background-image:none;text-align:center;">
                      ...
                      <p class="white-text" style="margin:0 0 18px;font-size:16px;color:#ffffff;">Aujourd&#8217;hui, les plateformes savent presque tout de nos usages&nbsp;: &#224; quel moment un &#233;pisode est lanc&#233;, interrompu ou repris, sur quel &#233;cran, &#224; quelle heure, et parfois presque &#224; la seconde pr&#232;s. Elles disent en revanche beaucoup moins bien ce qu&#8217;un projet provoque lorsqu&#8217;il est encore en d&#233;veloppement.</p>
                      <p class="white-text" style="margin:0 0 18px;font-size:16px;color:#ffffff;"><span style="display:inline-block;color:#ffffff !important;-webkit-text-fill-color:#ffffff !important;font-family:Arial,'Helvetica Neue','Segoe UI',sans-serif;font-weight:400;letter-spacing:0;text-transform:uppercase;">Give Me The Pitch</span> a &#233;t&#233; pens&#233; pour ouvrir les portes de cette phase &#224; celles et ceux qui regardent les s&#233;ries.</p>
                      <p class="white-text" style="margin:0 0 18px;font-size:16px;color:#ffffff;">En d&#233;couvrant <span style="display:inline-block;color:#ffffff !important;-webkit-text-fill-color:#ffffff !important;font-family:Arial,'Helvetica Neue','Segoe UI',sans-serif;font-weight:400;letter-spacing:0;text-transform:uppercase;">Mar&#233;e noire</span>, puis en partageant vos impressions, vous ne remplissez pas seulement un questionnaire&nbsp;: vous prenez place, d&#232;s l&#8217;amont, dans l&#8217;&#233;cosyst&#232;me du d&#233;veloppement t&#233;l&#233;visuel. Vos retours permettront de faire &#233;merger un premier signal autour du projet, mais aussi d&#8217;&#233;prouver la plateforme elle-m&#234;me dans cette version encore en rodage.</p>
                      <p class="white-text" style="margin:0 0 18px;font-size:16px;color:#ffffff;">Le parcours dure environ 30 minutes. Il d&#233;bute par un premier questionnaire consacr&#233; &#224; vos habitudes de visionnage et &#224; vos go&#251;ts en mati&#232;re de s&#233;ries, avant de se poursuivre par la lecture de <span style="display:inline-block;color:#ffffff !important;-webkit-text-fill-color:#ffffff !important;font-family:Arial,'Helvetica Neue','Segoe UI',sans-serif;font-weight:400;letter-spacing:0;text-transform:uppercase;">Mar&#233;e noire</span>. Il s&#8217;ach&#232;ve enfin par un second questionnaire destin&#233; &#224; recueillir vos impressions sur le projet.</p>
                      <p class="white-text" style="margin:0 0 28px;font-size:16px;color:#ffffff;">Vos retours sur le fond comme sur la forme auront donc toute leur place, y compris si quelques petits frottements de navigation se glissent encore dans le parcours.</p>
                      <p class="white-text" style="margin:0 0 28px;font-size:16px;color:#ffffff;">Pour un meilleur confort de lecture et de navigation, il est vivement recommand&#233; d&#8217;effectuer ce parcours sur un ordinateur.</p>
                      <div style="margin:0 0 22px;text-align:center;">
                        <span style="display:inline-block;max-width:100%;padding:9px 14px;border-radius:999px;background:#080808;background-color:#080808;background-image:none;border:1px solid #f5c6d8;color:#f5c6d8;-webkit-text-fill-color:#f5c6d8;font-family:Poppins,Arial,'Helvetica Neue','Segoe UI',sans-serif;font-size:11px;font-weight:300;letter-spacing:0.16em;line-height:1.45;text-transform:uppercase;text-align:center;box-sizing:border-box;">
                      ...
                      <div class="mint-bg" style="height:1px;line-height:1px;font-size:1px;background:#c8f5e8;background-color:#c8f5e8;background-image:linear-gradient(#c8f5e8,#c8f5e8);margin:0 0 18px;">&nbsp;</div>
                      <div class="mint-text" style="font-family:Poppins,Arial,'Helvetica Neue','Segoe UI',sans-serif;font-size:12px;font-weight:300;letter-spacing:0.22em;text-transform:uppercase;color:#c8f5e8;-webkit-text-fill-color:#c8f5e8;text-align:center;">
                        GIVE ME THE PITCH X THE ROOM
                      </div>
                    </td>
                  </tr>
...
Le parcours dure environ 30 minutes. Il débute par un premier questionnaire consacré à vos habitudes de visionnage et à vos goûts en matière de séries, avant de se poursuivre par la lecture de MARÉE NOIRE. Il s’achève enfin par un second questionnaire destiné à recueillir vos impressions sur le projet.
