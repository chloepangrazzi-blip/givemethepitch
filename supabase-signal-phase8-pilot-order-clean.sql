drop schema if exists "01_pilot_contacts" cascade;
drop schema if exists "02_pilot_recrutement" cascade;
drop schema if exists "03_pilot_signal" cascade;
drop schema if exists "04_pilot_projets" cascade;
drop schema if exists "05_pilot_vente" cascade;
...
select
  ...
  ct.statut_contact,
  ct.date_creation
from "01_pilot_contacts"."01_contacts" ct
