...
export default function CataloguePageClient({ page }) {
  ...
  useEffect(() => {
    ...
    const syncTabletOpiumHeight = () => {
      const opiumCard = document.querySelector('[data-project-id="opium"]');
      if (!opiumCard) {
        return;
      }
  ...
  const pageStyle = featuredHeight ? { "--featured-card-height": `${featuredHeight}px` } : undefined;
  ...
  return (
    <>
      ...
      <main className="catalog-page" style={pageStyle}>
          ...
          <section className="catalog-grid">
            {page.projects.map((project) => (
              <ProjectCard
                ...
                tabletOpiumHeight={tabletOpiumHeight}
